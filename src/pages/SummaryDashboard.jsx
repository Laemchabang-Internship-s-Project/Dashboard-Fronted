      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="stat-card bg-[#1e40af] text-white p-5 rounded-lg shadow-md relative overflow-hidden flex flex-col justify-between min-h-[140px]">
            ...
            <AnimatedStat value={stats.opdTotal} Component="h2" className="text-3xl font-bold mt-auto" />
          </div>
          ...
          <div className="stat-card bg-[#75cf48] text-white p-5 rounded-lg shadow-md flex flex-col justify-between min-h-[140px]">
            ...
            <AnimatedStat value={stats.walkIn} Component="h2" className="text-3xl font-bold mt-auto" />
          </div>
          ...
          <div className="stat-card bg-[#e88843] text-white p-5 rounded-lg shadow-md flex flex-col justify-between min-h-[140px]">
            ...
            <AnimatedStat value={stats.telemed} Component="h2" className="text-3xl font-bold mt-auto" />
          </div>
          ...
          <div className="stat-card bg-[#4b5563] text-white p-5 rounded-lg shadow-md flex flex-col justify-between min-h-[140px]">
            ...
            <AnimatedStat value={stats.drugDelivery} Component="h2" className="text-3xl font-bold mt-auto" />
          </div>
        </div>
            ...
            {[
              ...
              <div key={idx} className="bg-[#1e3a8a] text-white p-4 rounded-2xl shadow-lg flex flex-col items-center min-h-[140px] text-center">
                <div className="h-12 flex items-center justify-center mb-2">
                  <p className="text-sm font-light leading-tight">{item.label}</p>
                </div>
                <div className="mt-auto">
                  <AnimatedStat value={item.val} Component="h3" className="text-4xl font-bold" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                <div key={idx} className={`${item.bg} text-white p-4 rounded-2xl shadow-lg flex flex-col items-center min-h-[140px] text-center`}>
