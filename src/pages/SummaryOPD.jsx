          ...
          <div className={secondaryClasses}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
              {[
                ...
                { label: <>จำนวน ผู้รอรับบริการ รอตรวจ</>, val: stats.waitingExam },
                { label: <>จำนวน ผู้รอรับบริการ ห้องเจาะเลือด Lab</>, val: stats.waitingLab },
                { label: <>จำนวน ผู้รอรับบริการ ห้อง X-ray</>, val: stats.waitingXray }
              ].map((item, idx) => (
