...
export default function BedDashboard() {
  ...
  useEffect(() => {
    ...
    // ตั้งเวลาให้ดึงข้อมูลใหม่ทุกๆ 1 นาที (60000 ms) ตามที่ Backend Worker อัปเดต
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Object.entries(bedData.by_ward || {}).map(([wardName, stats]) => (
                <div key={wardName} className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
