...
export default function OPDDashboard() {
  ...
  const updateDashboardData = (data) => {
    ...
    setStats(prev => ({
      ...
      drugDeliveryPostal: s?.total_drug_delivery_postal ?? 0,
      drugDeliveryRider: s?.total_drug_delivery_rider ?? 0,
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-[6px]">
                  ...
                  <div className="stat-card bg-gradient-to-br from-[#F5F3FF] to-[#EDE9FE] text-[#1e293b] p-4 md:p-5 rounded-[14px] shadow-sm flex flex-col justify-between min-h-[120px] md:min-h-[140px]">
                    ...
                    <div className="flex items-end justify-between mt-auto gap-2">
                      ...
                      {/* ฝั่งซ้าย: ยอดรวม (ขยับลงมานิดนึงเพื่อให้รับกับกล่องขวา) */}
                      
                      <AnimatedStat value={stats.drugDelivery} Component="h2" className="text-[2rem] md:text-[2.8rem] font-bold" />
